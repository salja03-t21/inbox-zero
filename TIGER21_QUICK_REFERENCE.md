...
|------|---------|----------|
| `.env.tiger21` | Production credentials | **SERVER ONLY** (never in git) |
| `.env.tiger21.example` | Template | Git repository (safe) |
| `docker-compose.tiger21.yml` | Stack config | Git repository |
| `deploy-tiger21.sh` | Deploy script | Git repository |
| `TIGER21_DEPLOYMENT.md` | Full docs | Git repository |
| `TIGER21_DEPLOYMENT_CHECKLIST.md` | Checklist | Git repository |
